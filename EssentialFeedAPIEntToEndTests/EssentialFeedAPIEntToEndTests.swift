//
//  EssentialFeedAPIEntToEndTests.swift
//  EssentialFeedAPIEntToEndTests
//
...
final class EssentialFeedAPIEntToEndTests: XCTestCase {
    ...
    func test_endToEndTestServerGETFeedImageDataResult_matchesFixedTestAccountData() {
        ...
        case let .failure(error)?:
            XCTFail("Expected successsful image data result, got \(error) instead")
        default:
...
//MARK: - Helpers
    ...
    private func getFeedImageDataResult(file: StaticString = #file, line: UInt = #line) -> FeedImageDataLoader.Result? {
        ...
        _ = loader.loadImageData(from: testServerURL) {
            result in
            receivedResult = result
            exp.fulfill()
        }
